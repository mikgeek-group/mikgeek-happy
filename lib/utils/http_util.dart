...
import 'package:happyapp/utils/xml_util.dart';
...
class HttpUtil {
  ...
  Future<List<CategoryModel>> getCategoryList() async {
    ...
    try {
      if (isXml(res)) {
        ...
        return d.map((dynamic e) => CategoryModel.fromJson(e)).toList();
      }
    } catch (e) {
  ...
  Future<List<VideoModel>> getVideoList({
    ...
    if (keyword != null) {
      params["wd"] = Uri.encodeQueryComponent(keyword);
    }
    if (ids != null) {
      params["ids"] = ids;
    }
